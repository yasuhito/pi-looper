...
With auto-merge disabled, the reviewer automation can gather external review context, run a review worker, request fixes, and hand the PR to `ready-for-human` instead of merging.
